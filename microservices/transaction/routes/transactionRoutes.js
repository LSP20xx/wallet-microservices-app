...
router.post(
  ...
  transactionController.createService
);
router.get(
  "/:id",
  // authMiddleware,
  param("id").isMongoId().trim().escape(),
  transactionController.getServiceById
);
router.delete(
  "/:id",
  // Uncomment to enable role-based authorization for this route
  ...
  param("id").isMongoId().trim().escape(),
  transactionController.deleteService
);
router.put(
  "/:id",
  // Uncomment to enable role-based authorization for this route
  ...
  transactionController.updateService
);
router.get("/", transactionController.listServices);
